...
export default function CluberManagementPage() {
        ...
        return (
            <div className="min-h-screen bg-black flex items-center justify-center p-6 text-center">
                <div className="space-y-6">
                    <ShieldAlert className="h-20 w-20 text-[#cb465a] mx-auto animate-pulse" />
                    <h1 className="text-4xl font-black text-white uppercase tracking-tighter italic">ACCESS DENIED</h1>
                    <Button asChild className="bg-[#cb465a] text-white font-black rounded-xl">
    ...
    return (
        <div className="min-h-screen bg-black pb-32 selection:bg-[#cb465a]/30 font-inter">
            {/* Header Area */}
            <header className="pt-20 pb-16 px-6 md:px-12 bg-gradient-to-b from-[#cb465a]/20 to-transparent">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-10">
                        <div className="space-y-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="h-14 w-14 rounded-2xl bg-[#cb465a] flex items-center justify-center shadow-[0_0_30px_#cb465a]">
                            ...
                            <h1 className="text-7xl md:text-[9rem] font-black text-white uppercase tracking-tighter italic leading-[0.8] font-montserrat drop-shadow-2xl">
                                GESTIÓN DE <br/><span className="text-[#cb465a]">CLUBERS</span>
                            </h1>
                        ...
                        <div className="flex items-center gap-6 bg-white/5 backdrop-blur-2xl p-8 rounded-[3rem] border border-white/10 shadow-2xl">
                            <div className="text-right space-y-1">
                                <p className="text-[11px] font-black text-[#cb465a] uppercase tracking-widest">Master Protocol</p>
                            ...
                            <div className="h-16 w-16 rounded-[1.5rem] border-2 border-[#cb465a]/40 p-1 bg-black/40">
                                <div className="h-full w-full rounded-[1rem] bg-[#cb465a]/20 flex items-center justify-center animate-pulse">
                                    <Zap className="h-7 w-7 text-[#cb465a]" />
                                </div>
                            </div>
                        </div>
                    </div>
