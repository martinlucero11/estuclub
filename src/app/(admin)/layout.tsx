  ...
  return (
    <div className="flex h-screen bg-white relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-14 border-b border-white/5 bg-background/50 backdrop-blur-xl flex items-center px-6 justify-between z-40 sticky top-0 shrink-0">
        ...
        <div className="flex-1 p-6 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 relative overflow-x-hidden overflow-y-auto">
          {children}
        </div>
        <OrderStaleMonitor />
      </main>
