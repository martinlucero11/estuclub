...
export function AnnouncementTable() {
    ...
    const bannersQuery = useMemo(() => query(collection(firestore, 'announcements').withConverter(createConverter<Announcement>()), orderBy('createdAt', 'desc')), [firestore]);
    ...
    const handleEdit = (banner: SerializableAnnouncement) => {
