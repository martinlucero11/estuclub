...
export default function SupportPage() {
    return (
        <MainLayout>
            <div className="min-h-screen bg-white selection:bg-[#cb465a]/20 pb-32">
                {/* Hero Section */}
                <div className="relative pt-32 pb-20 overflow-hidden bg-background">
                    <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#cb465a]/10 blur-[120px] rounded-full translate-x-1/2 -translate-y-1/2" />
                    ...
                    <div className="max-w-4xl mx-auto px-6 relative z-10 text-center space-y-6">
                        <motion.div 
                            ...
                            className="inline-flex items-center gap-3 px-4 py-1.5 bg-[#cb465a]/20 rounded-full border border-[#cb465a]/30"
                        >
                            <HelpCircle className="h-4 w-4 text-[#cb465a]" />
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#cb465a]">Centro de Ayuda</span>
                        </motion.div>
                        <motion.h1 
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            ¿Cómo podemos <br/><span className="text-[#cb465a]">Ayudarte?</span>
                        </motion.h1>
                        <motion.p 
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            transition={{ delay: 0.2 }}
                            className="text-foreground font-medium text-lg max-w-xl mx-auto leading-relaxed"
                        >
                                ...
                                <Card className="rounded-[3rem] border-none shadow-[0_20px_60px_rgba(0,0,0,0.1)] bg-white hover:scale-[1.03] transition-all group overflow-hidden h-full"> 
                                    <CardContent className="p-10 flex flex-col items-center text-center space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-xs font-bold text-foreground uppercase tracking-widest leading-loose">{cat.description}</p>
                                        </div>
                                        <Button asChild className="w-full h-14 bg-background hover:bg-background text-white font-black uppercase tracking-widest rounded-2xl shadow-xl">
                ...
                <div className="max-w-4xl mx-auto px-6 mt-32 space-y-16">
                    <div className="text-center space-y-4">
                        <h2 className="text-4xl font-black uppercase italic tracking-tighter font-montserrat">Preguntas <span className="text-[#cb465a]">Frecuentes</span></h2>
                        <div className="h-[2px] w-20 bg-[#cb465a] mx-auto rounded-full" />
                    </div>
                    ...
                    <div className="grid gap-6">
                        {FAQS.map((faq, i) => (
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                                className="p-8 rounded-[2rem] bg-background border border-foreground space-y-3"
                            >
                                <h4 className="text-sm font-black uppercase tracking-widest text-foreground flex items-center gap-3">
                                    <HelpCircle className="h-4 w-4 text-[#cb465a]" /> {faq.q}
                                </h4>
                                <p className="text-xs font-medium text-foreground leading-relaxed ml-7">
                                    {faq.a}
                                </p>
                            </motion.div>
                        ))}
                ...
                <div className="max-w-4xl mx-auto px-6 mt-32">
                    <Card className="rounded-[3rem] border-none bg-gradient-to-br from-[#cb465a] to-[#f46087] p-12 text-white text-center shadow-2xl shadow-[#cb465a]/30">
                        <CardContent className="space-y-8">
                            ...
                            <Button variant="outline" asChild className="h-16 px-10 rounded-2xl bg-white text-[#cb465a] border-none font-black uppercase tracking-widest hover:bg-white/90 transition-all shadow-xl">
