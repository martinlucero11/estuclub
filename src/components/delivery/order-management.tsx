    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-12">
            {orders.map((order) => {
                ...
                return (
                    <Card key={order.id} className="overflow-hidden border-border/50 shadow-lg hover:border-primary/20 transition-all duration-300">
                            ...
                            <div className="flex justify-between items-start">
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                        <DropdownMenuItem onClick={() => updateStatus(order.id, 'accepted')}>Aceptar Pedido</DropdownMenuItem>
                                        <DropdownMenuItem onClick={() => updateStatus(order.id, 'shipped')}>Marcar en Camino</DropdownMenuItem>
                                        <DropdownMenuItem onClick={() => updateStatus(order.id, 'completed')} className="text-green-600">Completar</DropdownMenuItem>
                                        <DropdownMenuItem onClick={() => updateStatus(order.id, 'cancelled')} className="text-red-600">Cancelar</DropdownMenuItem>
                                    </DropdownMenuContent>
                                </DropdownMenu>
                            </div>
                        </CardHeader>
