        ...
        <div className="fixed inset-0 z-[100] bg-background/40 backdrop-blur-md flex items-center justify-center p-6">
            ...
            >
                <Card className="rounded-[3rem] border-none shadow-2xl bg-white overflow-hidden">
                    <div className="h-3 bg-[#cb465a] w-full" />
                    <CardContent className="p-10 text-center space-y-8">
                        <div className="relative mx-auto w-24 h-24">
                            <div className="absolute inset-0 bg-[#cb465a]/10 rounded-[2rem] animate-pulse" />
                            <div className="relative flex items-center justify-center h-full">
                                <ShieldAlert className="h-12 w-12 text-[#cb465a]" />
                            </div>
                        </div>

                        <div className="space-y-4">
                            <h2 className="text-3xl font-black italic uppercase tracking-tighter leading-none">Acceso <br/><span className="text-[#cb465a]">Restringido</span></h2>
                            <p className="text-xs font-bold text-foreground uppercase tracking-widest leading-loose">
                        ...
                        <div className="p-6 rounded-2xl bg-background border border-foreground flex items-center gap-4 text-left">
                            <Wallet className="h-10 w-10 text-foreground flex-shrink-0" />
                        ...
                        <Button 
                            onClick={handleLink}
                            className="w-full h-16 bg-[#cb465a] hover:bg-[#cb465a]/90 text-white font-black uppercase tracking-widest rounded-3xl shadow-xl shadow-[#cb465a]/20"
                        >
                            VINCULAR AHORA <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>

                        <p className="text-[9px] font-bold text-foreground uppercase tracking-widest italic">
